	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">Smart Developer</h1>
			</div>
         	...
         	<div class="row">
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the lecture Tutorials , Notes , Projects and important Interview questions related to programming languages 
				 ...
				 <!-- <div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the Notes related to programming languages 
         					like JAVA,PYTHON,ANDROID etc
         				</p>
         			</div>
         		</div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the Projects related to programming languages 
         					like JAVA,PYTHON,ANDROID etc
         				</p>
         			</div>
         		</div>
				 ...
				 <div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<h3><a href=" ">iNTERVIEW QUESTIONS</a></h3>
         				<p>
         					Here you will find all the Interview Questions related to programming languages 
         					like JAVA,PYTHON,ANDROID etc
         				</p>
         			</div>
         		</div> -->
...
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				...
				<p class="text-center">join us to improve your works join us to improve your works and skills</p>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/Babita.jpeg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Babita Lohani</h4>
									<h4 class="team-member-designation">BCA Student  (20042150)</h4>
							...
							<div class="team-member text-center">
								<img src="img/ravi.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Ravi Bhatt</h4>
									<h4 class="team-member-designation">BCA Student  (20041131)</h4>
									<ul class="social-list">
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												Smart Developer is an online E-learning website <br>
												here you can learn programming languages,Projects,important Question related Interview and improve your coding skill	
											</p>
										</div>
									</div>
								</div>
